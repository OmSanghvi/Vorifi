...
/**
 * Component for rendering a custom tooltip for displaying date, income, and expenses.
 *
 * This component displays a tooltip with formatted date, income, and expenses values.
 *
