...
/**
 * DateFilter component for selecting and filtering data by date range.
 *
 * This component allows users to select a date range and updates the URL with the selected range.
 * It also provides a reset functionality to clear the selected date range.
 *
...
export const DateFilter = () => {
    ...
    /**
     * Updates the URL with the selected date range.
     *
    ...
    /**
     * Resets the selected date range and updates the URL.
     */
    const onReset = () => {
        setDate(undefined);
        pushToUrl(undefined);
    ...
    return (
        <Popover>
            <PopoverTrigger asChild>
                <Button disabled={false} size="sm" variant="outline" className="lg:w-auto w-full h-9 rounded-md px-3 font-normal bg-white/10 hover:bg-white/20
