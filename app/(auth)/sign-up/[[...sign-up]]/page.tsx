...
/**
 * The main page component for the sign-up page.
 *
 * This component renders a sign-up form using Clerk, with a loading state and a button to navigate to the home page.
 *
